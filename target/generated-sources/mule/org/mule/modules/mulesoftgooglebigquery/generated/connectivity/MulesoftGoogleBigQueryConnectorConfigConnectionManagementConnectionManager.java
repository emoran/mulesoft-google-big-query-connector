...
import org.mule.modules.mulesoftgooglebigquery.generated.adapters.MulesoftGoogleBigQueryConnectorConnectionManagementAdapter;
import org.mule.modules.mulesoftgooglebigquery.generated.pooling.DevkitGenericKeyedObjectPool;


/**
 * A {@code MulesoftGoogleBigQueryConnectorConfigConnectionManagementConnectionManager} is a wrapper around {@link MulesoftGoogleBigQueryConnector } that adds connection management capabilities to the pojo.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.4", date = "2020-02-21T08:47:59-05:00", comments = "Build UNNAMED.2810.4347dd1")
public class MulesoftGoogleBigQueryConnectorConfigConnectionManagementConnectionManager
    extends ExpressionEvaluatorSupport
    implements MetadataAware, MuleContextAware, ProcessAdapter<MulesoftGoogleBigQueryConnectorConnectionManagementAdapter> , Capabilities, Disposable, Initialisable, Testable, ConnectionManagementConnectionManager<ConnectionManagementConfigMulesoftGoogleBigQueryConnectorConnectionKey, MulesoftGoogleBigQueryConnectorConnectionManagementAdapter, ConnectorConfig>
{
    ...
    public MulesoftGoogleBigQueryConnectorConnectionManagementAdapter acquireConnection(ConnectionManagementConfigMulesoftGoogleBigQueryConnectorConnectionKey key)
        throws Exception
    {
        return ((MulesoftGoogleBigQueryConnectorConnectionManagementAdapter) connectionPool.borrowObject(key));
    }

    public void releaseConnection(ConnectionManagementConfigMulesoftGoogleBigQueryConnectorConnectionKey key, MulesoftGoogleBigQueryConnectorConnectionManagementAdapter connection)
        throws Exception
    {
        connectionPool.returnObject(key, connection);
    }

    public void destroyConnection(ConnectionManagementConfigMulesoftGoogleBigQueryConnectorConnectionKey key, MulesoftGoogleBigQueryConnectorConnectionManagementAdapter connection)
        throws Exception
    {
    ...
    @Override
    public<P >ProcessTemplate<P, MulesoftGoogleBigQueryConnectorConnectionManagementAdapter> getProcessTemplate() {
        return new ConnectionManagementProcessTemplate(this, muleContext);
    }

    @Override
    public ConnectionManagementConfigMulesoftGoogleBigQueryConnectorConnectionKey getDefaultConnectionKey() {
        return new ConnectionManagementConfigMulesoftGoogleBigQueryConnectorConnectionKey(getUsername(), getPassword());
    }

    @Override
    public ConnectionManagementConfigMulesoftGoogleBigQueryConnectorConnectionKey getEvaluatedConnectionKey(MuleEvent event)
        throws Exception
    {
        if (event!= null) {
            ...
            return new ConnectionManagementConfigMulesoftGoogleBigQueryConnectorConnectionKey(_transformedUsername, _transformedPassword);
        }
    ...
    @Override
    public ConnectionManagementConfigMulesoftGoogleBigQueryConnectorConnectionKey getConnectionKey(MessageProcessor messageProcessor, MuleEvent event)
        throws Exception
    {
    ...
    public ConnectionManagementConnectionAdapter newConnection() {
        ConnectorConfigMulesoftGoogleBigQueryConnectorAdapter connection = new ConnectorConfigMulesoftGoogleBigQueryConnectorAdapter();
    ...
    @Override
    public ConnectionManagementConnectorAdapter newConnector(ConnectionManagementConnectionAdapter<ConnectorConfig, ConnectionManagementConfigMulesoftGoogleBigQueryConnectorConnectionKey> connection) {
        MulesoftGoogleBigQueryConnectorConnectionManagementAdapter connector = new MulesoftGoogleBigQueryConnectorConnectionManagementAdapter();
    ...
    public ConnectionManagementConnectionAdapter getConnectionAdapter(ConnectionManagementConnectorAdapter adapter) {
        MulesoftGoogleBigQueryConnectorConnectionManagementAdapter connector = ((MulesoftGoogleBigQueryConnectorConnectionManagementAdapter) adapter);
    ...
    public TestResult test() {
        try {
            ConnectorConfigMulesoftGoogleBigQueryConnectorAdapter strategy = ((ConnectorConfigMulesoftGoogleBigQueryConnectorAdapter) newConnection());
