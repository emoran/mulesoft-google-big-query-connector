...
/**
 * A <code>MulesoftGoogleBigQueryConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link MulesoftGoogleBigQueryConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.4", date = "2020-02-21T08:47:59-05:00", comments = "Build UNNAMED.2810.4347dd1")
public class MulesoftGoogleBigQueryConnectorLifecycleInjectionAdapter
    extends MulesoftGoogleBigQueryConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(MulesoftGoogleBigQueryConnectorLifecycleInjectionAdapter.class);
