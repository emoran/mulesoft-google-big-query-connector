...
package org.mule.modules.mulesoftgooglebigquery.generated.config;

import javax.annotation.Generated;
import org.mule.config.MuleManifest;
import org.mule.config.PoolingProfile;
import org.mule.modules.mulesoftgooglebigquery.generated.connectivity.MulesoftGoogleBigQueryConnectorConfigConnectionManagementConnectionManager;
...
public class MulesoftGoogleBigQueryConnectorConnectorConfigConfigDefinitionParser
    extends AbstractDevkitBasedDefinitionParser
{

    private static Logger logger = LoggerFactory.getLogger(MulesoftGoogleBigQueryConnectorConnectorConfigConfigDefinitionParser.class);

    public String moduleName() {
        return "MulesoftGoogleBigQuery";
    }
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        setInitMethodIfNeeded(builder, MulesoftGoogleBigQueryConnectorConfigConnectionManagementConnectionManager.class);
        setDestroyMethodIfNeeded(builder, MulesoftGoogleBigQueryConnectorConfigConnectionManagementConnectionManager.class);
    ...
    private BeanDefinitionBuilder getBeanDefinitionBuilder(ParserContext parserContext) {
        try {
            return BeanDefinitionBuilder.rootBeanDefinition(MulesoftGoogleBigQueryConnectorConfigConnectionManagementConnectionManager.class.getName());
            ...
            logger.error(("Cannot launch the mule app, the configuration [config] within the connector [mulesoft-google-big-query] is not supported in mule "+ muleVersion));
            throw new BeanDefinitionParsingException(new Problem(("Cannot launch the mule app, the configuration [config] within the connector [mulesoft-google-big-query] is not supported in mule "+ muleVersion), new Location(parserContext.getReaderContext().getResource()), null, noClassDefFoundError));
        }
    }
